 ...
 */
export declare enum InferenceProfileType {
    /**
 ...
 */
export declare abstract class InferenceProfileBase extends Resource implements IInferenceProfile {
    /**
     * The ARN of the inference profile.
     * @attribute
     */
     ...
     */
    abstract readonly type: InferenceProfileType;
    /**
     * Grants appropriate permissions to use the inference profile.
     * Each profile type requires different permissions based on its usage pattern:
     ...
     * @returns An IAM Grant object representing the granted permissions
     */
    abstract grantProfileUsage(grantee: IGrantable): Grant;
}
