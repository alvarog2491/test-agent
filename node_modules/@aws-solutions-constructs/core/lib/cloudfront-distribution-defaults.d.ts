 ...
 */
export declare function DefaultCloudFrontWebDistributionForApiGatewayProps(apiEndPoint: api.RestApiBase, loggingBucket: s3.Bucket | undefined, setHttpSecurityHeaders: boolean, cfFunction?: cloudfront.IFunction, responseHeadersPolicy?: cloudfront.ResponseHeadersPolicy): cloudfront.DistributionProps;
/**
 * @internal This is an internal core function and should not be called directly by Solutions Constructs clients.
 */
