 ...
 */
export declare abstract class KendraGenAiIndexBase extends Resource implements IKendraGenAiIndex {
 ...
 */
export declare class KendraGenAiIndex extends KendraGenAiIndexBase {
    /**
     * Import a guardrail given its attributes
     */
    static fromAttrs(scope: Construct, id: string, attrs: KendraGenAiIndexAttributes): IKendraGenAiIndex;
    readonly indexArn: string;
    readonly indexId: string;
    readonly role: iam.IRole;
    /**
     ...
     */
    readonly edition: Kendra.Edition;
    /**
