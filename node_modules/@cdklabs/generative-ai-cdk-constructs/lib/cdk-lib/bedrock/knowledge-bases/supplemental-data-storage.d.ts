...
export declare enum SupplementalDataStorageLocationType {
    /**
 ...
 */
export declare class SupplementalDataStorageLocation {
    /**
     ...
     */
    static s3(config: SupplementalDataStorageS3Config): SupplementalDataStorageLocation;
    /**
     * The type of the storage location
     */
    readonly type: SupplementalDataStorageLocationType;
    /**
     * The configuration for the storage location
     */
    readonly locationConfig: SupplementalDataStorageLocationConfig;
    /**
     ...
     */
    constructor(type: SupplementalDataStorageLocationType, locationConfig: SupplementalDataStorageLocationConfig);
    /**
     * Renders as Cfn Property
     * @internal This is an internal core function and should not be called directly.
     */
    __render(): CfnKnowledgeBase.SupplementalDataStorageLocationProperty;
}
