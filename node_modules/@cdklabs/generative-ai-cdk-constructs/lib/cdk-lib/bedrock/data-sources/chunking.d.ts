...
export declare abstract class ChunkingStrategy {
     ...
     */
    static readonly HIERARCHICAL_COHERE: ChunkingStrategy;
    /**
     ...
     */
    static readonly HIERARCHICAL_TITAN: ChunkingStrategy;
    /**
     ...
     */
    static readonly SEMANTIC: ChunkingStrategy;
    /**
     * Amazon Bedrock treats each file as one chunk. Suitable for documents that
     * are already pre-processed or text split.
     */
    static readonly NONE: ChunkingStrategy;
    /** Method for customizing a fixed sized chunking strategy. */
    static fixedSize(props: CfnDataSource.FixedSizeChunkingConfigurationProperty): ChunkingStrategy;
    /**
     ...
     */
    static hierarchical(props: HierarchicalChunkingProps): ChunkingStrategy;
    /**
     ...
     * - Cohere Embed models: 512
     */
    static semantic(props: CfnDataSource.SemanticChunkingConfigurationProperty): ChunkingStrategy;
    /** Method for defining a no chunking strategy. */
    private static noChunking;
    /** The CloudFormation property representation of this configuration */
    abstract configuration: CfnDataSource.ChunkingConfigurationProperty;
    private constructor();
}
